...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _performLogin() {
    print('🎯 Botón presionado - Iniciando login');
  ...
  bool _isFormValid() {
    ...
    print('📋 Validación: $isValid (email: $email, password: ${'*' * password.length})');
    return isValid;
  }
              ...
              children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextField(
                          ...
                          onChanged: (_) {
                            setState(() {}); // Forzar rebuild para validación
                        ...
                        TextField(
                          ...
                          onSubmitted: (_) {
                            if (_isFormValid() && !_authController.isLoading.value) {
                              _performLogin();
                            }
                          },
                        ),
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    _passwordController.text = '111111';
                    setState(() {});
                    print('✅ Credenciales de prueba establecidas');
                  },
                  style: ElevatedButton.styleFrom(
